...
assert.equal(request.assumptions.costProfile, 'standard');
assert.equal(request.assumptions.panelFormFactor, 'compactResidential');
assert.equal(request.assumptions.costAssumptionVersion, 'TR-2026-Q2-COST-v1');
assert.equal(request.assumptions.financialAssumptionVersion, 'TR-2026-Q2-FIN-v1');
assert.equal(request.tariff.financialAssumptionVersion, 'TR-2026-Q2-FIN-v1');
assert.equal(request.tariff.tariffIncreaseCurve[0].rate, 0.22);
assert.equal(request.tariff.discountRate, 0.32);
