...
const PANEL_TYPE_PROFILES = {
  mono_perc: {
    ...
    badge: "Dengeli seçim",
    summary: "Klasik tek yüzeyli panel mimarisi. Maliyet ile performans arasında dengeli çözüm arayan kurulumlar için güvenli tercih.",
    exampleModel: "Trina Vertex S TSM-DE09R.08",
    exampleSize: "1762 × 1134 × 30 mm",
    powerRange: "415–435 W",
    cellLayout: "144 yarım hücre",
    bestFor: "Standart konut kurulumu",
  ...
  n_type_topcon: {
    ...
    summary: "Yeni nesil yüksek verimli panel sınıfı. Aynı alanda daha yüksek güç kurmaya yardımcı olur ve sıcak iklimde PERC'e göre daha dengeli davranır.",
    exampleModel: "Trina Vertex S+ TSM-NEG9R.28",
    exampleSize: "1762 × 1134 × 30 mm",
    powerRange: "430–455 W",
    cellLayout: "144 yarım hücre, dual-glass",
    bestFor: "Alanı kısıtlı ama üretim hedefi yüksek kurulumlar",
  ...
  bifacial_topcon: {
    ...
    watchFor: "Koyu zeminli ve yüzeye sıfır kurulumda arka yüz kazancı sınırlı kalır.",
    efficiency: 0.233,
    wattPeak: 455,
    width: 1.134, height: 1.762,
    tempCoeff: -0.0029,
...
export const INVERTER_TYPES = {
  string: {
    ...
    summary: 'Tüm panel dizilerini tek merkezde DC/AC çeviren klasik çözüm. Kurulum yüzeyleri benzerse en ekonomik mimaridir.',
    ...
    bestFor: 'Tek yönlü, düşük gölgeli yüzey',
    efficiency: 0.984,
    maxInputDcV: 600,
    mpptOptimalV: 360,
    ...
    advantages: ['Düşük ekipman maliyeti', 'Servis ve bakım nispeten kolay', 'Standart yüzeylerde güçlü verim'],
    disadvantages: ['Aynı string içindeki zayıf panel tüm diziyi etkiler', 'Karmaşık kurulum geometrilerinde esnekliği sınırlı']
  },
  micro: {
    name: 'Mikro İnverter',
    badge: 'Panel bazlı kontrol',
    summary: 'Her panel altında ayrı çevirici bulunur. Farklı yön, kısmi gölge ve panel bazlı izleme gereken kurulumlarda öne çıkar.',
    ...
    bestFor: 'Karma yönler ve gölgeli yüzeyler',
    efficiency: 0.975,
    maxInputDcV: 60,
    mpptOptimalV: 40,
    ...
    disadvantages: ['İlk yatırım maliyeti yüksektir', 'Saha üzerinde daha fazla elektronik bileşen olur']
  },
  optimizer: {
    ...
    monitoring: 'Panel bazında izleme',
    bestFor: 'Gölgeli fakat merkezi servis avantajı istenen kurulum',
    efficiency: 0.990,
    maxInputDcV: 480,
    mpptOptimalV: 380,
