...
export const PANEL_CATALOG = [
  ...
  },
  {
    ...
    // Tiger Neo 3.0 54-cell rooftop modüllerinin tipik fiziksel ölçüsü; SKU bazlı varyasyon var.
    dimensions: '1762 × 1134 × 30 mm (SKU bazlı doğrulanır)',
    weight: '21 kg sınıfı (SKU bazlı doğrulanır)',
    temperatureCoeffText: '-0.29%/°C sınıfı (SKU bazlı doğrula)',
    modeledTempCoeffPerC: -0.0029,
    vocStcV: 51.5,
    vmpStcV: 42.0,
    vocCoeffPctPerC: -0.25,
