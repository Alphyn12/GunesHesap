...
const SENSITIVE_KEYS = new Set([
  ...
  'customTariffIncreaseCurve', 'customDiscountRate', 'manualCostOverrides', 'manualVatRates',
...
const STATE_KEYS = [
  ...
  'inverterType', 'costProfile', 'panelFormFactor', 'financialProfile', 'vatProfile',
  'manualCostMode', 'manualCostOverrides', 'manualVatRates',
  'multiRoof', 'roofSections', 'roofGeometry', 'dailyConsumption', 'designTarget',
  ...
  'discountRate', 'customTariffIncreaseCurve', 'customDiscountRate',
  'tariffIncludesTax', 'tariffSourceDate', 'tariffSourceCheckedAt',
